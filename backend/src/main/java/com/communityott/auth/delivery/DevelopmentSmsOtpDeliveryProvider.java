...
/**
 * Development implementation of SmsOtpDeliveryProvider.
 * Enables end-to-end local testing without external SMS gateway credentials.
 *
...
@Slf4j
@Component
public class DevelopmentSmsOtpDeliveryProvider implements SmsOtpDeliveryProvider {

    public static final String PROVIDER_NAME = "DEV_SMS";
    ...
    public OtpDeliveryResult send(String identifier, String otp, OtpPurpose purpose) {
        log.info("Simulating SMS OTP delivery via {} for purpose: {}", PROVIDER_NAME, purpose);
        ...
        String deliveryId = "dev-sms-" + UUID.randomUUID();

        return OtpDeliveryResult.builder()
                .success(true)
                .channel(AuthIdentifierType.PHONE)
